...
const SYSTEM = [
  ...
  "When the answer leans on specific grounded items (a distilled transcript, a session insight, a team's or person's record), close the prose with a line reading `Sources:` followed by one `- exact title/name` bullet per item, taken verbatim from the context. That trailing list is the ONLY place to cite: never sprinkle links or citation markers through the text. Skip the list when the answer doesn't draw on specific items.",
