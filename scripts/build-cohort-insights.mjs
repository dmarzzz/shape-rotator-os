...
function main(argv = process.argv.slice(2)) {
  ...
  console.log(`[build-cohort-insights] wrote ${opts.out} (${bundle.quality.card_count} cards: ${bundle.quality.kind_counts.say_did_shipped} say/did/shipped, ${bundle.quality.kind_counts.latent_overlap} latent overlaps)`);
}
