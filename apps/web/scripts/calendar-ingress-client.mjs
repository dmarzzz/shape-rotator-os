...
export const DEFAULT_ROUTING_POLICY = {
  ...
  drive_vault: {
    ...
    folder_routes: {
      ...
      leadership_meeting: {
        ...
        access_note: "Leadership/admins only (Andrew, Tina, Dmarz, core admins); candid program-direction discussion. Tightest-held route; never distilled, never reaches cohort/public surfaces.",
      },
      unknown: {
  ...
  manual_classification_checks: [
    ...
    {
      when: "leadership/steering conversation among the principals (Andrew, Tina, Dmarz, core admins) about Shape Rotator's own direction, roadmap, people, or partner decisions",
  ...
  session_types: {
    ...
    leadership_meeting: {
      ...
      description: "Candid leadership/steering conversation among the principals about Shape Rotator's own direction.",
      ...
      default_auto_transcript: false,
      required_public_approvals: [],
      notes: "Andrew/Tina/Dmarz/core-admin direction-setting. Tightest-held route; admins/leadership only, never distilled to cohort or public. Distinct from planning_strategy: this is the unfiltered principals' conversation, not shared governance/ops work product. The policy locks where the transcript lands and how far it travels; whether a Meet recording is created is governed separately by the calendar Meet-artifacts reconciler.",
    },
  },
};
